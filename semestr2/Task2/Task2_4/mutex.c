...
int counter = 0;
// глянуть что атомана ассемблер: atomic_compare_exchange_strong,
// глянуть реализацию в https://elixir.bootlin.com/glibc/glibc-2.37/source/sysdeps/nptl/futex-internal.h#L317
void set_cpu(int n) {
	int err;
	cpu_set_t cpuset;
